  ...
  return (
    <section id="services" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="relative mt-6 overflow-hidden">
        ...
        >
          {[...projectImages.slice().reverse(), ...projectImages.slice().reverse()].map((image, index) => (
            <div
              key={`project-row2-${index}`}
              className="flex-shrink-0 w-72 rounded-xl overflow-hidden bg-card/50 backdrop-blur-sm border border-border/30"
            >
              <div className="aspect-video overflow-hidden">
                <img
                  src={image}
